...
st.set_page_config(
    page_title="Cycle Menstruel",
    page_icon="🌸",
    layout="centered"
)
st.markdown("""
# 🌸 Bienvenue dans le calculateur de cycle menstruel
Cette application vous permet de suivre vos cycles, estimer vos dates d’ovulation et visualiser les prochaines périodes.
""")
